...
Inputs: Use /agents/agent-making-agent/README.md as the standard.
...
Inputs: Use /guides/AGENT_MAKING_INSTRUCTIONS.md and /agents/agent-making-agent/README.md as the standard.
Constraints: Review only, no file edits.
